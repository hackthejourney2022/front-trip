    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <FormContent>
        ...
        <Row gutter={30}>
          <Col sm={12}>
            <FormControl
              label="Hotel Name"
              htmlFor="hotelName"
              error={errors.hotelName && <span>Este campo é obrigatório!</span>}
            >
              <Controller
                name="hotelName"
        ...
        <FormControl
          ...
          error={
            errors.hotelDescription && <span>Este campo é obrigatório!</span>
          }
        >
          <Controller
        ...
        <FormControl
          ...
          error={errors.guest && <span>Este campo é obrigatório!</span>}
        >
          <InputIncDec
            name="guest"
        ...
        <FormControl
          ...
          error={errors.bed && <span>Este campo é obrigatório!</span>}
        >
          <InputIncDec
            name="bed"
